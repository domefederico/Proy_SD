...
function App() {
  ...
  const handleIniciarFlujo = async () => {
    try {
      ...
      // Caso especial: no hay contenedores llenos
      if (data.noContainers) {
        alert('ℹ️ No hay contenedores que necesiten vaciarse\n\nTodos los contenedores están por debajo del 75% de llenado. Espera unos segundos a que los sensores generen nuevos datos automáticamente.');
        return false;
      }
